...
const DEFAULT_DB = {
  ...
  users: [
    ...
    { id: 'u-stk5', tenant_id: 't1', region_id: 'r1', phone: '5432109999', name: 'Ramesh Kumar', role: 'STOCKIST', kyc_status: 'PENDING', no_show_count: 0, kyc_details: JSON.stringify({ id_type: 'Aadhaar', id_number: '9876-5432-1098', shop_name: 'Ramesh Store', shop_address: 'Garia Main Road', document_photo_url: '/api/kyc/documents/sample-aadhaar.jpg' }), address: 'Garia Main Road', created_at: new Date().toISOString(), is_active: true },
